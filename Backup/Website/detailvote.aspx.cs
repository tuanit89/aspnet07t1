...
public partial class Detailvote : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    //string sql1 = "select tblvote.idPic from tblvote where vote=1 and tblvote.idPic<" + id + " group by tblvote.idPic having count(vote)>2 order by idPic desc";
        //    //string sql2 = "select tblvote.idPic from tblvote where vote=1 and tblvote.idPic>" + id + " group by tblvote.idPic having count(vote)>2";
        ...
        //            video.Visible = true;
        //        }
        //        DataTable dt = DataAccess.GetFacebook("http://duocday.com/Detailvote.aspx?ID=" + id);
        ...
        //                            + "<a class=\"prev\" href=\"Detailvote.aspx?ID=" + truoc + "\" >Ảnh trước</a></div>";
        //        }
        //        if (truoc == 0)
        //        {
        //            truocsau.Text = "<div class=\"navButtons\">"
        //                            + " <a class=\"next\" href=\"Detailvote.aspx?ID=" + sau + "\">Ảnh sau</a></div>";
        //        }
        //        if (truoc != 0 && sau != 0)
        //        {
        //            truocsau.Text = "<div class=\"navButtons\">"
        //                            + "<a class=\"prev\" href=\"Detailvote.aspx?ID=" + truoc + "\" >Ảnh trước</a> <a class=\"next\" href=\"Detailvote.aspx?ID=" + sau + "\">Ảnh sau</a></div>";
        //        }
