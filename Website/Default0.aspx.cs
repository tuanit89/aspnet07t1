    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
           ...
           // dtlphoto.DataBind();
            ...
            //{
            //    DataTable dt = DataAccess.GetFacebook("http://duocday.com/Detailphoto.aspx?ID=" + ds.Tables[0].Rows[i][3].ToString());
            //    //DataTable dt = DataAccess.GetFacebook("http://localhost:1344/duocday/Detailphoto.aspx?ID=" + ds.Tables[0].Rows[i][3].ToString());
